...
JNICALL jstring native_getSeed(JNIEnv* env, jobject jobj, jstring mnemonic, jstring mnemonicPassword) {
    const char* mne = env->GetStringUTFChars(mnemonic, nullptr);
    const char* mnePwd = env->GetStringUTFChars(mnemonicPassword, nullptr);

    std::string seed = IdentityManager::GetSeed(mne, mnePwd);
...
static const JNINativeMethod gMethods[] = {
        ...
        {"native_getSeed", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", (void*)native_getSeed},
